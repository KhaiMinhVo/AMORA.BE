...
namespace Amora.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260724132854_HardenReportModeration")]
    partial class HardenReportModeration
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Amora.Domain.Entities.UserPushToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Amora.Domain.Entities.UserReport", b =>
                {
                    ...
                    b.Property<DateTimeOffset?>("AiEvaluatedAt")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.HasIndex("ReporterId", "TargetUserId", "CreatedAt");
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Status = "Pending",
                            TargetUserId = new Guid("44444444-4444-4444-4444-444444444444")
                        });
                });
